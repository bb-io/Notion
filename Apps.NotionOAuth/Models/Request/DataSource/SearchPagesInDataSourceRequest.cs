...
public class SearchPagesInDataSourceRequest : ListRequest
{
    [Display("Checkbox property"), DataSource(typeof(CheckboxDatabasePropertyDataHandler))]
    public string? CheckboxProperty { get; set; }

    [Display("Select property"), DataSource(typeof(SelectDatabasePropertyDataHandler))]
